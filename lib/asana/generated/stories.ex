defmodule Asana.Generated.Stories do
  @moduledoc """
  ...
  @type create_story_for_task_201_json_resp :: %{data: Asana.Generated.StoryResponse.t() | nil}
  ...
  **Content Types**: `application/json`
  ...
  @spec create_story_for_task(task_gid :: String.t(), body :: map, opts :: keyword) ::
          {:ok, Asana.Generated.Stories.create_story_for_task_201_json_resp()}
  ...
  def create_story_for_task(task_gid, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Generated.Stories, :create_story_for_task},
      ...
      response: [
        {201, {Asana.Generated.Stories, :create_story_for_task_201_json_resp}},
  ...
  @type delete_story_200_json_resp :: %{data: map | nil}
  ...
  @spec delete_story(story_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Generated.Stories.delete_story_200_json_resp()}
          | {:error, Asana.Generated.ErrorResponse.t()}
  def delete_story(story_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Generated.Stories, :delete_story},
      url: "/stories/#{story_gid}",
      method: :delete,
      query: query,
      response: [
        {200, {Asana.Generated.Stories, :delete_story_200_json_resp}},
        {400, {Asana.Generated.ErrorResponse, :t}},
        {401, {Asana.Generated.ErrorResponse, :t}},
        {403, {Asana.Generated.ErrorResponse, :t}},
        {404, {Asana.Generated.ErrorResponse, :t}},
  ...
  @type get_stories_for_task_200_json_resp :: %{
          data: [Asana.Generated.StoryCompact.t()] | nil,
  ...
  @spec get_stories_for_task(task_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Generated.Stories.get_stories_for_task_200_json_resp()}
          | {:error, Asana.Generated.ErrorResponse.t()}
  def get_stories_for_task(task_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Generated.Stories, :get_stories_for_task},
      url: "/tasks/#{task_gid}/stories",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Generated.Stories, :get_stories_for_task_200_json_resp}},
        {400, {Asana.Generated.ErrorResponse, :t}},
        {401, {Asana.Generated.ErrorResponse, :t}},
        {403, {Asana.Generated.ErrorResponse, :t}},
        {404, {Asana.Generated.ErrorResponse, :t}},
  ...
  @type get_story_200_json_resp :: %{data: Asana.Generated.StoryResponse.t() | nil}
  ...
  @spec get_story(story_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Generated.Stories.get_story_200_json_resp()}
          | {:error, Asana.Generated.ErrorResponse.t()}
  def get_story(story_gid, opts \\ []) do
    ...
    client.request(%{
      args: [story_gid: story_gid],
      call: {Asana.Generated.Stories, :get_story},
      url: "/stories/#{story_gid}",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Generated.Stories, :get_story_200_json_resp}},
        {400, {Asana.Generated.ErrorResponse, :t}},
        {401, {Asana.Generated.ErrorResponse, :t}},
        {403, {Asana.Generated.ErrorResponse, :t}},
        {404, {Asana.Generated.ErrorResponse, :t}},
  ...
  @type update_story_200_json_resp :: %{data: Asana.Generated.StoryResponse.t() | nil}
  ...
  **Content Types**: `application/json`
  ...
  @spec update_story(story_gid :: String.t(), body :: map, opts :: keyword) ::
          {:ok, Asana.Generated.Stories.update_story_200_json_resp()}
          | {:error, Asana.Generated.ErrorResponse.t()}
  def update_story(story_gid, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Generated.Stories, :update_story},
      url: "/stories/#{story_gid}",
      body: body,
      method: :put,
      query: query,
      request: [{"application/json", :map}],
      response: [
        {200, {Asana.Generated.Stories, :update_story_200_json_resp}},
        {400, {Asana.Generated.ErrorResponse, :t}},
        {401, {Asana.Generated.ErrorResponse, :t}},
        {403, {Asana.Generated.ErrorResponse, :t}},
        {404, {Asana.Generated.ErrorResponse, :t}},
  ...
  def __fields__(:create_story_for_task_201_json_resp) do
    [data: {Asana.Generated.StoryResponse, :t}]
  end
  ...
  def __fields__(:get_stories_for_task_200_json_resp) do
    [data: [{Asana.Generated.StoryCompact, :t}], next_page: {Asana.Generated.NextPage, :t}]
  end
