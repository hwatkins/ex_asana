defmodule Asana.Generated.TeamResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          name: String.t() | nil,
          organization: Asana.Generated.TeamResponseOrganization.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      name: :string,
      organization: {Asana.Generated.TeamResponseOrganization, :t},
