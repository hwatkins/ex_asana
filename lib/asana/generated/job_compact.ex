defmodule Asana.Generated.JobCompact do
  @moduledoc """
  Provides struct and type for a JobCompact
  """
  ...
  @type t :: %__MODULE__{
          ...
          new_task: Asana.Generated.JobCompactNewTask.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      new_task: {Asana.Generated.JobCompactNewTask, :t},
