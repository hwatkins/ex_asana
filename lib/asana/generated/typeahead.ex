defmodule Asana.Generated.Typeahead do
  @moduledoc """
  ...
  @spec typeahead_for_workspace(workspace_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Generated.Typeahead.typeahead_for_workspace_200_json_resp()}
  ...
  def typeahead_for_workspace(workspace_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Generated.Typeahead, :typeahead_for_workspace},
      url: "/workspaces/#{workspace_gid}/typeahead",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Generated.Typeahead, :typeahead_for_workspace_200_json_resp}},
  ...
  def __fields__(:typeahead_for_workspace_200_json_resp) do
    [data: [{Asana.Generated.AsanaNamedResource, :t}]]
  end
end
