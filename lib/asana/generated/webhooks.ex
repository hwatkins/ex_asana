defmodule Asana.Generated.Webhooks do
  @moduledoc """
  ...
  @type create_webhook_201_json_resp :: %{
          ...
          data: Asana.Generated.WebhookResponse.t() | nil
        }
  ...
  **Content Types**: `application/json`
  ...
  @spec create_webhook(body :: map, opts :: keyword) ::
          {:ok, Asana.Generated.Webhooks.create_webhook_201_json_resp()}
  ...
  def create_webhook(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Asana.Generated.Webhooks, :create_webhook},
      url: "/webhooks",
      body: body,
      method: :post,
      query: query,
      ...
      response: [
        {201, {Asana.Generated.Webhooks, :create_webhook_201_json_resp}},
  ...
  @type delete_webhook_200_json_resp :: %{data: map | nil}
  ...
  @spec delete_webhook(webhook_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Generated.Webhooks.delete_webhook_200_json_resp()}
          | {:error, Asana.Generated.ErrorResponse.t()}
  def delete_webhook(webhook_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Generated.Webhooks, :delete_webhook},
      url: "/webhooks/#{webhook_gid}",
      method: :delete,
      query: query,
      response: [
        {200, {Asana.Generated.Webhooks, :delete_webhook_200_json_resp}},
        {400, {Asana.Generated.ErrorResponse, :t}},
        {401, {Asana.Generated.ErrorResponse, :t}},
        {403, {Asana.Generated.ErrorResponse, :t}},
        {404, {Asana.Generated.ErrorResponse, :t}},
  ...
  @type get_webhook_200_json_resp :: %{data: Asana.Generated.WebhookResponse.t() | nil}
  ...
  @spec get_webhook(webhook_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Generated.Webhooks.get_webhook_200_json_resp()}
          | {:error, Asana.Generated.ErrorResponse.t()}
  def get_webhook(webhook_gid, opts \\ []) do
    ...
    client.request(%{
      args: [webhook_gid: webhook_gid],
      call: {Asana.Generated.Webhooks, :get_webhook},
      url: "/webhooks/#{webhook_gid}",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Generated.Webhooks, :get_webhook_200_json_resp}},
        {400, {Asana.Generated.ErrorResponse, :t}},
        {401, {Asana.Generated.ErrorResponse, :t}},
        {403, {Asana.Generated.ErrorResponse, :t}},
        {404, {Asana.Generated.ErrorResponse, :t}},
  ...
  @spec get_webhooks(opts :: keyword) ::
          {:ok, Asana.Generated.Webhooks.get_webhooks_200_json_resp()}
          | {:error, Asana.Generated.ErrorResponse.t()}
  def get_webhooks(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Asana.Generated.Webhooks, :get_webhooks},
      url: "/webhooks",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Generated.Webhooks, :get_webhooks_200_json_resp}},
        {400, {Asana.Generated.ErrorResponse, :t}},
        {401, {Asana.Generated.ErrorResponse, :t}},
        {403, {Asana.Generated.ErrorResponse, :t}},
        {404, {Asana.Generated.ErrorResponse, :t}},
  ...
  @type update_webhook_200_json_resp :: %{data: Asana.Generated.WebhookResponse.t() | nil}
  ...
  **Content Types**: `application/json`
  ...
  @spec update_webhook(webhook_gid :: String.t(), body :: map, opts :: keyword) ::
          {:ok, Asana.Generated.Webhooks.update_webhook_200_json_resp()}
          | {:error, Asana.Generated.ErrorResponse.t()}
  def update_webhook(webhook_gid, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Generated.Webhooks, :update_webhook},
      url: "/webhooks/#{webhook_gid}",
      body: body,
      method: :put,
      query: query,
      request: [{"application/json", :map}],
      response: [
        {200, {Asana.Generated.Webhooks, :update_webhook_200_json_resp}},
        {400, {Asana.Generated.ErrorResponse, :t}},
        {401, {Asana.Generated.ErrorResponse, :t}},
        {403, {Asana.Generated.ErrorResponse, :t}},
        {404, {Asana.Generated.ErrorResponse, :t}},
  ...
  def __fields__(:create_webhook_201_json_resp) do
    ["X-Hook-Secret": :string, data: {Asana.Generated.WebhookResponse, :t}]
  end
  ...
  def __fields__(:get_webhook_200_json_resp) do
    [data: {Asana.Generated.WebhookResponse, :t}]
  end

  def __fields__(:get_webhooks_200_json_resp) do
    [data: [{Asana.Generated.WebhookResponse, :t}], next_page: {Asana.Generated.NextPage, :t}]
  end
