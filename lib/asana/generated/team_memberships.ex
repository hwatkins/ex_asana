defmodule Asana.Generated.TeamMemberships do
  @moduledoc """
  ...
  @type get_team_membership_200_json_resp :: %{
  ...
  @spec get_team_membership(team_membership_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Generated.TeamMemberships.get_team_membership_200_json_resp()}
  ...
  def get_team_membership(team_membership_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Generated.TeamMemberships, :get_team_membership},
      url: "/team_memberships/#{team_membership_gid}",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Generated.TeamMemberships, :get_team_membership_200_json_resp}},
  ...
  @type get_team_memberships_200_json_resp :: %{
          data: [Asana.Generated.TeamMembershipCompact.t()] | nil,
  ...
  @spec get_team_memberships(opts :: keyword) ::
          {:ok, Asana.Generated.TeamMemberships.get_team_memberships_200_json_resp()}
          | {:error, Asana.Generated.ErrorResponse.t()}
  def get_team_memberships(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Asana.Generated.TeamMemberships, :get_team_memberships},
      url: "/team_memberships",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Generated.TeamMemberships, :get_team_memberships_200_json_resp}},
        {400, {Asana.Generated.ErrorResponse, :t}},
        {401, {Asana.Generated.ErrorResponse, :t}},
        {403, {Asana.Generated.ErrorResponse, :t}},
        {404, {Asana.Generated.ErrorResponse, :t}},
  ...
  @type get_team_memberships_for_team_200_json_resp :: %{
          data: [Asana.Generated.TeamMembershipCompact.t()] | nil,
          next_page: Asana.Generated.NextPage.t() | nil
        }
  ...
  @spec get_team_memberships_for_team(team_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Generated.TeamMemberships.get_team_memberships_for_team_200_json_resp()}
          | {:error, Asana.Generated.ErrorResponse.t()}
  def get_team_memberships_for_team(team_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Generated.TeamMemberships, :get_team_memberships_for_team},
      url: "/teams/#{team_gid}/team_memberships",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Generated.TeamMemberships, :get_team_memberships_for_team_200_json_resp}},
        {400, {Asana.Generated.ErrorResponse, :t}},
        {401, {Asana.Generated.ErrorResponse, :t}},
        {403, {Asana.Generated.ErrorResponse, :t}},
        {404, {Asana.Generated.ErrorResponse, :t}},
  ...
  @type get_team_memberships_for_user_200_json_resp :: %{
          data: [Asana.Generated.TeamMembershipCompact.t()] | nil,
          next_page: Asana.Generated.NextPage.t() | nil
        }
  ...
  @spec get_team_memberships_for_user(user_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Generated.TeamMemberships.get_team_memberships_for_user_200_json_resp()}
          | {:error, Asana.Generated.ErrorResponse.t()}
  def get_team_memberships_for_user(user_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Generated.TeamMemberships, :get_team_memberships_for_user},
      url: "/users/#{user_gid}/team_memberships",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Generated.TeamMemberships, :get_team_memberships_for_user_200_json_resp}},
        {400, {Asana.Generated.ErrorResponse, :t}},
        {401, {Asana.Generated.ErrorResponse, :t}},
        {403, {Asana.Generated.ErrorResponse, :t}},
        {404, {Asana.Generated.ErrorResponse, :t}},
  ...
  def __fields__(:get_team_membership_200_json_resp) do
    [data: {Asana.Generated.TeamMembershipResponse, :t}]
  end

  def __fields__(:get_team_memberships_200_json_resp) do
    [
      data: [{Asana.Generated.TeamMembershipCompact, :t}],
      next_page: {Asana.Generated.NextPage, :t}
    ]
  end

  def __fields__(:get_team_memberships_for_team_200_json_resp) do
    [
      data: [{Asana.Generated.TeamMembershipCompact, :t}],
      next_page: {Asana.Generated.NextPage, :t}
    ]
  ...
  def __fields__(:get_team_memberships_for_user_200_json_resp) do
    [
      data: [{Asana.Generated.TeamMembershipCompact, :t}],
      next_page: {Asana.Generated.NextPage, :t}
    ]
