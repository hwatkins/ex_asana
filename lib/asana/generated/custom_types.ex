defmodule Asana.Generated.CustomTypes do
  @moduledoc """
  ...
  @type get_custom_type_200_json_resp :: %{data: Asana.Generated.CustomTypeResponse.t() | nil}
  ...
  @spec get_custom_type(custom_type_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Generated.CustomTypes.get_custom_type_200_json_resp()}
  ...
  def get_custom_type(custom_type_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Generated.CustomTypes, :get_custom_type},
      url: "/custom_types/#{custom_type_gid}",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Generated.CustomTypes, :get_custom_type_200_json_resp}},
  ...
  @type get_custom_types_200_json_resp :: %{
          data: [Asana.Generated.CustomTypeResponse.t()] | nil,
  ...
  @spec get_custom_types(opts :: keyword) ::
          {:ok, Asana.Generated.CustomTypes.get_custom_types_200_json_resp()}
          | {:error, Asana.Generated.ErrorResponse.t()}
  def get_custom_types(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Asana.Generated.CustomTypes, :get_custom_types},
      url: "/custom_types",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Generated.CustomTypes, :get_custom_types_200_json_resp}},
        {400, {Asana.Generated.ErrorResponse, :t}},
        {401, {Asana.Generated.ErrorResponse, :t}},
        {403, {Asana.Generated.ErrorResponse, :t}},
        {404, {Asana.Generated.ErrorResponse, :t}},
  ...
  def __fields__(:get_custom_type_200_json_resp) do
    [data: {Asana.Generated.CustomTypeResponse, :t}]
  end

  def __fields__(:get_custom_types_200_json_resp) do
    [data: [{Asana.Generated.CustomTypeResponse, :t}], next_page: {Asana.Generated.NextPage, :t}]
  end
end
