defmodule Asana.Generated.ProjectMemberships do
  @moduledoc """
  ...
  @type get_project_membership_200_json_resp :: %{
          data: Asana.Generated.ProjectMembershipNormalResponse.t() | nil
        }
  ...
  @spec get_project_membership(project_membership_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Generated.ProjectMemberships.get_project_membership_200_json_resp()}
  ...
  def get_project_membership(project_membership_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Generated.ProjectMemberships, :get_project_membership},
      url: "/project_memberships/#{project_membership_gid}",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Generated.ProjectMemberships, :get_project_membership_200_json_resp}},
  ...
  @type get_project_memberships_for_project_200_json_resp :: %{
          data: [Asana.Generated.ProjectMembershipCompact.t()] | nil,
  ...
  @spec get_project_memberships_for_project(project_gid :: String.t(), opts :: keyword) ::
          {:ok,
           Asana.Generated.ProjectMemberships.get_project_memberships_for_project_200_json_resp()}
          | {:error, Asana.Generated.ErrorResponse.t()}
  def get_project_memberships_for_project(project_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Generated.ProjectMemberships, :get_project_memberships_for_project},
  ...
  def __fields__(:get_project_membership_200_json_resp) do
    [data: {Asana.Generated.ProjectMembershipNormalResponse, :t}]
  end

  def __fields__(:get_project_memberships_for_project_200_json_resp) do
    [
      data: [{Asana.Generated.ProjectMembershipCompact, :t}],
