defmodule Asana.Generated.Roles do
  @moduledoc """
  ...
  @type create_role_201_json_resp :: %{data: Asana.Generated.RbacRoleResponse.t() | nil}
  ...
  **Content Types**: `application/json`
  ...
  @spec create_role(body :: map, opts :: keyword) ::
          {:ok, Asana.Generated.Roles.create_role_201_json_resp()}
  ...
  def create_role(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Asana.Generated.Roles, :create_role},
      url: "/roles",
      body: body,
      method: :post,
      query: query,
      ...
      response: [
        {201, {Asana.Generated.Roles, :create_role_201_json_resp}},
  ...
  @type delete_role_200_json_resp :: %{data: map | nil}
  ...
  @spec delete_role(role_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Generated.Roles.delete_role_200_json_resp()}
          | {:error, Asana.Generated.ErrorResponse.t()}
  def delete_role(role_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Generated.Roles, :delete_role},
      url: "/roles/#{role_gid}",
      method: :delete,
      query: query,
      response: [
        {200, {Asana.Generated.Roles, :delete_role_200_json_resp}},
        {400, {Asana.Generated.ErrorResponse, :t}},
        {401, {Asana.Generated.ErrorResponse, :t}},
        {403, {Asana.Generated.ErrorResponse, :t}},
        {404, {Asana.Generated.ErrorResponse, :t}},
  ...
  @type get_role_200_json_resp :: %{data: Asana.Generated.RbacRoleResponse.t() | nil}
  ...
  @spec get_role(role_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Generated.Roles.get_role_200_json_resp()}
          | {:error, Asana.Generated.ErrorResponse.t()}
  def get_role(role_gid, opts \\ []) do
    ...
    client.request(%{
      args: [role_gid: role_gid],
      call: {Asana.Generated.Roles, :get_role},
      url: "/roles/#{role_gid}",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Generated.Roles, :get_role_200_json_resp}},
        {400, {Asana.Generated.ErrorResponse, :t}},
        {401, {Asana.Generated.ErrorResponse, :t}},
        {403, {Asana.Generated.ErrorResponse, :t}},
        {404, {Asana.Generated.ErrorResponse, :t}},
  ...
  @type get_roles_200_json_resp :: %{
          data: [Asana.Generated.RbacRoleCompact.t()] | nil,
  ...
  @spec get_roles(opts :: keyword) ::
          {:ok, Asana.Generated.Roles.get_roles_200_json_resp()}
          | {:error, Asana.Generated.ErrorResponse.t()}
  def get_roles(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Asana.Generated.Roles, :get_roles},
      url: "/roles",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Generated.Roles, :get_roles_200_json_resp}},
        {400, {Asana.Generated.ErrorResponse, :t}},
        {401, {Asana.Generated.ErrorResponse, :t}},
        {403, {Asana.Generated.ErrorResponse, :t}},
        {404, {Asana.Generated.ErrorResponse, :t}},
  ...
  @type update_role_200_json_resp :: %{data: Asana.Generated.RbacRoleResponse.t() | nil}
  ...
  **Content Types**: `application/json`
  ...
  @spec update_role(role_gid :: String.t(), body :: map, opts :: keyword) ::
          {:ok, Asana.Generated.Roles.update_role_200_json_resp()}
          | {:error, Asana.Generated.ErrorResponse.t()}
  def update_role(role_gid, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Generated.Roles, :update_role},
      url: "/roles/#{role_gid}",
      body: body,
      method: :put,
      query: query,
      request: [{"application/json", :map}],
      response: [
        {200, {Asana.Generated.Roles, :update_role_200_json_resp}},
        {400, {Asana.Generated.ErrorResponse, :t}},
        {401, {Asana.Generated.ErrorResponse, :t}},
        {403, {Asana.Generated.ErrorResponse, :t}},
        {404, {Asana.Generated.ErrorResponse, :t}},
  ...
  def __fields__(:create_role_201_json_resp) do
    [data: {Asana.Generated.RbacRoleResponse, :t}]
  end
  ...
  def __fields__(:get_roles_200_json_resp) do
    [data: [{Asana.Generated.RbacRoleCompact, :t}], next_page: {Asana.Generated.NextPage, :t}]
  end
