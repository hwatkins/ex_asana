defmodule Asana.CustomFieldSettings do
  @moduledoc """
  ...
  @spec get_custom_field_settings_for_goal(goal_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.CustomField.Settings.get_custom_field_settings_for_goal_200_json_resp()}
          | {:error, Asana.Error.t()}
  def get_custom_field_settings_for_goal(goal_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.CustomFieldSettings, :get_custom_field_settings_for_goal},
      url: "/goals/#{goal_gid}/custom_field_settings",
      method: :get,
      query: query,
      response: [
        {200, {Asana.CustomField.Settings, :get_custom_field_settings_for_goal_200_json_resp}},
  ...
  @spec get_custom_field_settings_for_portfolio(portfolio_gid :: String.t(), opts :: keyword) ::
          {:ok,
           Asana.CustomField.Settings.get_custom_field_settings_for_portfolio_200_json_resp()}
          | {:error, Asana.Error.t()}
  def get_custom_field_settings_for_portfolio(portfolio_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.CustomFieldSettings, :get_custom_field_settings_for_portfolio},
  ...
  @spec get_custom_field_settings_for_project(project_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.CustomField.Settings.get_custom_field_settings_for_project_200_json_resp()}
          | {:error, Asana.Error.t()}
  def get_custom_field_settings_for_project(project_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.CustomFieldSettings, :get_custom_field_settings_for_project},
      url: "/projects/#{project_gid}/custom_field_settings",
      method: :get,
      query: query,
      response: [
        {200, {Asana.CustomField.Settings, :get_custom_field_settings_for_project_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
        {403, {Asana.Error, :response}},
        {404, {Asana.Error, :response}},
  ...
  @spec get_custom_field_settings_for_team(team_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.CustomField.Settings.get_custom_field_settings_for_team_200_json_resp()}
          | {:error, Asana.Error.t()}
  def get_custom_field_settings_for_team(team_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.CustomFieldSettings, :get_custom_field_settings_for_team},
      url: "/teams/#{team_gid}/custom_field_settings",
      method: :get,
      query: query,
      response: [
        {200, {Asana.CustomField.Settings, :get_custom_field_settings_for_team_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
        {403, {Asana.Error, :response}},
        {404, {Asana.Error, :response}},
