defmodule Asana.TimeTrackingEntries do
  @moduledoc """
  ...
  @type create_time_tracking_entry_201_json_resp :: %{
          __info__: map,
          data: Asana.TimeTrackingEntry.base() | nil
        }
  ...
  **Content Types**: `application/json`
  ...
  @spec create_time_tracking_entry(task_gid :: String.t(), body :: map, opts :: keyword) ::
          {:ok, Asana.TimeTrackingEntries.create_time_tracking_entry_201_json_resp()}
          | {:error, Asana.Error.t()}
  def create_time_tracking_entry(task_gid, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.TimeTrackingEntries, :create_time_tracking_entry},
      ...
      response: [
        {201, {Asana.TimeTrackingEntries, :create_time_tracking_entry_201_json_resp}},
  ...
  @type delete_time_tracking_entry_200_json_resp :: %{__info__: map, data: map | nil}
  ...
  @spec delete_time_tracking_entry(time_tracking_entry_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.TimeTrackingEntries.delete_time_tracking_entry_200_json_resp()}
          | {:error, Asana.Error.t()}
  def delete_time_tracking_entry(time_tracking_entry_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.TimeTrackingEntries, :delete_time_tracking_entry},
      url: "/time_tracking_entries/#{time_tracking_entry_gid}",
      method: :delete,
      query: query,
      response: [
        {200, {Asana.TimeTrackingEntries, :delete_time_tracking_entry_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
        {403, {Asana.Error, :response}},
        {404, {Asana.Error, :response}},
  ...
  @type get_time_tracking_entries_200_json_resp :: %{
          __info__: map,
          data: [Asana.TimeTrackingEntry.compact()] | nil,
  ...
  @spec get_time_tracking_entries(opts :: keyword) ::
          {:ok, Asana.TimeTrackingEntries.get_time_tracking_entries_200_json_resp()}
          | {:error, Asana.Error.t()}
  def get_time_tracking_entries(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Asana.TimeTrackingEntries, :get_time_tracking_entries},
      url: "/time_tracking_entries",
      method: :get,
      query: query,
      response: [
        {200, {Asana.TimeTrackingEntries, :get_time_tracking_entries_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
  ...
  @spec get_time_tracking_entries_for_task(task_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.TimeTrackingEntries.get_time_tracking_entries_for_task_200_json_resp()}
          | {:error, Asana.Error.t()}
  def get_time_tracking_entries_for_task(task_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.TimeTrackingEntries, :get_time_tracking_entries_for_task},
      url: "/tasks/#{task_gid}/time_tracking_entries",
      method: :get,
      query: query,
      response: [
        {200, {Asana.TimeTrackingEntries, :get_time_tracking_entries_for_task_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
        {403, {Asana.Error, :response}},
        {404, {Asana.Error, :response}},
  ...
  @spec get_time_tracking_entry(time_tracking_entry_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.TimeTrackingEntries.get_time_tracking_entry_200_json_resp()}
          | {:error, Asana.Error.t()}
  def get_time_tracking_entry(time_tracking_entry_gid, opts \\ []) do
    ...
    client.request(%{
      args: [time_tracking_entry_gid: time_tracking_entry_gid],
      call: {Asana.TimeTrackingEntries, :get_time_tracking_entry},
      url: "/time_tracking_entries/#{time_tracking_entry_gid}",
      method: :get,
      query: query,
      response: [
        {200, {Asana.TimeTrackingEntries, :get_time_tracking_entry_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
        {403, {Asana.Error, :response}},
        {404, {Asana.Error, :response}},
  ...
  **Content Types**: `application/json`
  ...
  @spec update_time_tracking_entry(
          ...
          {:ok, Asana.TimeTrackingEntries.update_time_tracking_entry_200_json_resp()}
          | {:error, Asana.Error.t()}
  def update_time_tracking_entry(time_tracking_entry_gid, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.TimeTrackingEntries, :update_time_tracking_entry},
      url: "/time_tracking_entries/#{time_tracking_entry_gid}",
      body: body,
      method: :put,
      query: query,
      request: [{"application/json", :map}],
      response: [
        {200, {Asana.TimeTrackingEntries, :update_time_tracking_entry_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
        {403, {Asana.Error, :response}},
        {404, {Asana.Error, :response}},
  ...
  def __fields__(:create_time_tracking_entry_201_json_resp) do
    [data: {Asana.TimeTrackingEntry, :base}]
  end
  ...
  def __fields__(:get_time_tracking_entries_200_json_resp) do
    [data: [{Asana.TimeTrackingEntry, :compact}], next_page: {Asana.NextPage, :t}]
  end
