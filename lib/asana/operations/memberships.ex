defmodule Asana.Memberships do
  @moduledoc """
  ...
  @type create_membership_201_json_resp :: %{
          __info__: map,
          data:
            Asana.CustomField.Membership.response()
            | Asana.CustomType.Membership.response()
            | Asana.Goal.Membership.response()
            | Asana.Portfolio.Membership.response()
            | Asana.Project.Membership.Compact.response()
            | nil
        }
  ...
  **Content Types**: `application/json`
  ...
  @spec create_membership(body :: map, opts :: keyword) ::
          {:ok, Asana.Memberships.create_membership_201_json_resp()} | {:error, Asana.Error.t()}
  def create_membership(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Asana.Memberships, :create_membership},
      url: "/memberships",
      body: body,
      method: :post,
      query: query,
      ...
      response: [
        {201, {Asana.Memberships, :create_membership_201_json_resp}},
  ...
  @type delete_membership_200_json_resp :: %{__info__: map, data: map | nil}
  ...
  @spec delete_membership(membership_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Memberships.delete_membership_200_json_resp()} | {:error, Asana.Error.t()}
  def delete_membership(membership_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Memberships, :delete_membership},
      url: "/memberships/#{membership_gid}",
      method: :delete,
      query: query,
      response: [
        {200, {Asana.Memberships, :delete_membership_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
        {403, {Asana.Error, :response}},
        {404, {Asana.Error, :response}},
  ...
  @spec get_membership(membership_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Memberships.get_membership_200_json_resp()} | {:error, Asana.Error.t()}
  def get_membership(membership_gid, opts \\ []) do
    ...
    client.request(%{
      args: [membership_gid: membership_gid],
      call: {Asana.Memberships, :get_membership},
      url: "/memberships/#{membership_gid}",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Memberships, :get_membership_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
        {403, {Asana.Error, :response}},
        {404, {Asana.Error, :response}},
  ...
  @type get_memberships_200_json_resp :: %{
          ...
          data:
            [
              Asana.CustomField.Membership.compact()
              | Asana.CustomType.Membership.compact()
              | Asana.Goal.Membership.compact()
              | Asana.Portfolio.Membership.Compact.response()
              | Asana.Project.Membership.Compact.response()
            ]
            | nil,
  ...
  @spec get_memberships(opts :: keyword) ::
          {:ok, Asana.Memberships.get_memberships_200_json_resp()} | {:error, Asana.Error.t()}
  def get_memberships(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Asana.Memberships, :get_memberships},
      url: "/memberships",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Memberships, :get_memberships_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
        {403, {Asana.Error, :response}},
        {404, {Asana.Error, :response}},
  ...
  **Content Types**: `application/json`
  ...
  @spec update_membership(membership_gid :: String.t(), body :: map, opts :: keyword) ::
          {:ok, Asana.Memberships.update_membership_200_json_resp()} | {:error, Asana.Error.t()}
  def update_membership(membership_gid, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Memberships, :update_membership},
      url: "/memberships/#{membership_gid}",
      body: body,
      method: :put,
      query: query,
      request: [{"application/json", :map}],
      response: [
        {200, {Asana.Memberships, :update_membership_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
        {403, {Asana.Error, :response}},
        {404, {Asana.Error, :response}},
