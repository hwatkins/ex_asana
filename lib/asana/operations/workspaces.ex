defmodule Asana.Workspaces do
  ...
  @type add_user_for_workspace_200_json_resp :: %{
          __info__: map,
          data: Asana.User.Base.response() | nil
        }
  ...
  **Content Types**: `application/json`
  ...
  @spec add_user_for_workspace(workspace_gid :: String.t(), body :: map, opts :: keyword) ::
          {:ok, Asana.Workspaces.add_user_for_workspace_200_json_resp()}
          | {:error, Asana.Error.t()}
  def add_user_for_workspace(workspace_gid, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Workspaces, :add_user_for_workspace},
      ...
      response: [
        {200, {Asana.Workspaces, :add_user_for_workspace_200_json_resp}},
  ...
  @type get_workspace_200_json_resp :: %{__info__: map, data: Asana.Workspace.response() | nil}
  ...
  @spec get_workspace(workspace_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Workspaces.get_workspace_200_json_resp()} | {:error, Asana.Error.t()}
  def get_workspace(workspace_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Workspaces, :get_workspace},
      url: "/workspaces/#{workspace_gid}",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Workspaces, :get_workspace_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
        {403, {Asana.Error, :response}},
        {404, {Asana.Error, :response}},
  ...
  @spec get_workspace_events(workspace_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Workspaces.get_workspace_events_200_json_resp()} | {:error, Asana.Error.t()}
  def get_workspace_events(workspace_gid, opts \\ []) do
    ...
    client.request(%{
      args: [workspace_gid: workspace_gid],
      call: {Asana.Workspaces, :get_workspace_events},
      url: "/workspaces/#{workspace_gid}/events",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Workspaces, :get_workspace_events_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
        {403, {Asana.Error, :response}},
        {404, {Asana.Error, :response}},
  ...
  @type get_workspaces_200_json_resp :: %{
          __info__: map,
          data: [Asana.Workspace.compact()] | nil,
  ...
  @spec get_workspaces(opts :: keyword) ::
          {:ok, Asana.Workspaces.get_workspaces_200_json_resp()} | {:error, Asana.Error.t()}
  def get_workspaces(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Asana.Workspaces, :get_workspaces},
      url: "/workspaces",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Workspaces, :get_workspaces_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
        {403, {Asana.Error, :response}},
        {404, {Asana.Error, :response}},
  ...
  @type remove_user_for_workspace_200_json_resp :: %{__info__: map, data: map | nil}
  ...
  **Content Types**: `application/json`
  ...
  @spec remove_user_for_workspace(workspace_gid :: String.t(), body :: map, opts :: keyword) ::
          {:ok, Asana.Workspaces.remove_user_for_workspace_200_json_resp()}
          | {:error, Asana.Error.t()}
  def remove_user_for_workspace(workspace_gid, body, opts \\ []) do
    ...
    client.request(%{
      args: [workspace_gid: workspace_gid, body: body],
      call: {Asana.Workspaces, :remove_user_for_workspace},
      ...
      request: [{"application/json", :map}],
      response: [
        {200, {Asana.Workspaces, :remove_user_for_workspace_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
        {403, {Asana.Error, :response}},
        {404, {Asana.Error, :response}},
  ...
  @type update_workspace_200_json_resp :: %{__info__: map, data: Asana.Workspace.response() | nil}
  ...
  **Content Types**: `application/json`
  ...
  @spec update_workspace(workspace_gid :: String.t(), body :: map, opts :: keyword) ::
          {:ok, Asana.Workspaces.update_workspace_200_json_resp()} | {:error, Asana.Error.t()}
  def update_workspace(workspace_gid, body, opts \\ []) do
    ...
    client.request(%{
      args: [workspace_gid: workspace_gid, body: body],
      call: {Asana.Workspaces, :update_workspace},
      url: "/workspaces/#{workspace_gid}",
      body: body,
      method: :put,
      query: query,
      request: [{"application/json", :map}],
      response: [
        {200, {Asana.Workspaces, :update_workspace_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
        {403, {Asana.Error, :response}},
        {404, {Asana.Error, :response}},
  ...
  def __fields__(:add_user_for_workspace_200_json_resp) do
    [data: {Asana.User.Base, :response}]
  end

  def __fields__(:get_workspace_200_json_resp) do
    [data: {Asana.Workspace, :response}]
  end
  ...
  def __fields__(:get_workspaces_200_json_resp) do
    [data: [{Asana.Workspace, :compact}], next_page: {Asana.NextPage, :t}]
  end
