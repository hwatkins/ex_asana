defmodule Asana.Exports do
  ...
  @type create_graph_export_201_json_resp :: %{
          __info__: map,
          data: Asana.GraphExport.response() | nil
        }
  ...
  **Content Types**: `application/json`
  ...
  @spec create_graph_export(body :: map, opts :: keyword) ::
          {:ok, Asana.Exports.create_graph_export_201_json_resp()} | {:error, Asana.Error.t()}
  def create_graph_export(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Asana.Exports, :create_graph_export},
      url: "/exports/graph",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {Asana.Exports, :create_graph_export_201_json_resp}},
  ...
  @type create_resource_export_201_json_resp :: %{
          __info__: map,
          data: Asana.ResourceExport.response() | nil
        }
  ...
  **Content Types**: `application/json`
  ...
  @spec create_resource_export(body :: map, opts :: keyword) ::
          {:ok, Asana.Exports.create_resource_export_201_json_resp()} | {:error, Asana.Error.t()}
  def create_resource_export(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Asana.Exports, :create_resource_export},
      url: "/exports/resource",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {Asana.Exports, :create_resource_export_201_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
        {403, {Asana.Error, :response}},
        {404, {Asana.Error, :response}},
  ...
  def __fields__(:create_graph_export_201_json_resp) do
    [data: {Asana.GraphExport, :response}]
  end

  def __fields__(:create_resource_export_201_json_resp) do
    [data: {Asana.ResourceExport, :response}]
  end
end
