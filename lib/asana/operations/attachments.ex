defmodule Asana.Attachments do
  ...
  @type create_attachment_for_object_200_json_resp :: %{
          __info__: map,
          data: Asana.Attachment.response() | nil
        }
  ...
  *Note when using curl:*
  ...
  """
  @spec create_attachment_for_object(body :: Asana.Attachment.Request.t(), opts :: keyword) ::
          {:ok, Asana.Attachments.create_attachment_for_object_200_json_resp()}
          | {:error, Asana.Error.t()}
  def create_attachment_for_object(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Asana.Attachments, :create_attachment_for_object},
      url: "/attachments",
      body: body,
      method: :post,
      query: query,
      request: [{"multipart/form-data", {Asana.Attachment.Request, :t}}],
      response: [
        {200, {Asana.Attachments, :create_attachment_for_object_200_json_resp}},
  ...
  @type delete_attachment_200_json_resp :: %{__info__: map, data: map | nil}
  ...
  @spec delete_attachment(attachment_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Attachments.delete_attachment_200_json_resp()} | {:error, Asana.Error.t()}
  def delete_attachment(attachment_gid, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Asana.Attachments, :delete_attachment},
      url: "/attachments/#{attachment_gid}",
      method: :delete,
      query: query,
      response: [
        {200, {Asana.Attachments, :delete_attachment_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
        {403, {Asana.Error, :response}},
        {404, {Asana.Error, :response}},
  ...
  @type get_attachment_200_json_resp :: %{__info__: map, data: Asana.Attachment.response() | nil}
  ...
  @spec get_attachment(attachment_gid :: String.t(), opts :: keyword) ::
          {:ok, Asana.Attachments.get_attachment_200_json_resp()} | {:error, Asana.Error.t()}
  def get_attachment(attachment_gid, opts \\ []) do
    ...
    client.request(%{
      args: [attachment_gid: attachment_gid],
      call: {Asana.Attachments, :get_attachment},
      url: "/attachments/#{attachment_gid}",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Attachments, :get_attachment_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
  ...
  @type get_attachments_for_object_200_json_resp :: %{
          __info__: map,
          data: [Asana.Attachment.compact()] | nil,
  ...
  @spec get_attachments_for_object(opts :: keyword) ::
          {:ok, Asana.Attachments.get_attachments_for_object_200_json_resp()}
          | {:error, Asana.Error.t()}
  def get_attachments_for_object(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Asana.Attachments, :get_attachments_for_object},
      url: "/attachments",
      method: :get,
      query: query,
      response: [
        {200, {Asana.Attachments, :get_attachments_for_object_200_json_resp}},
        {400, {Asana.Error, :response}},
        {401, {Asana.Error, :response}},
        {403, {Asana.Error, :response}},
        {404, {Asana.Error, :response}},
  ...
  def __fields__(:create_attachment_for_object_200_json_resp) do
    [data: {Asana.Attachment, :response}]
  end
  ...
  def __fields__(:get_attachments_for_object_200_json_resp) do
    [data: [{Asana.Attachment, :compact}], next_page: {Asana.NextPage, :t}]
  end
end
