...
defmodule Asana.Api.Tasks do
  ...
  @spec create_comment_story(
          Asana.Connection.t(),
          String.t(),
          Asana.Model.InlineObject10.t(),
          keyword()
        ) ::
          {:ok, Asana.Model.Error.t()}
          | {:ok, Asana.Model.StoryObject.t()}
          | {:error, Req.Response.t()}
