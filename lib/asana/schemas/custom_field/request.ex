defmodule Asana.CustomField.Request do
  @moduledoc """
  Provides struct and type for a CustomField.Request
  """
  use Asana.Encoder
  ...
  @type t :: %__MODULE__{
          ...
          date_value: Asana.CustomField.RequestDateValue.t() | nil,
          description: String.t() | nil,
          display_value: String.t() | nil,
          enabled: boolean | nil,
          enum_options: [Asana.EnumOption.t()] | nil,
          enum_value: Asana.CustomField.RequestEnumValue.t() | nil,
          format: String.t() | nil,
          gid: String.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      date_value: {Asana.CustomField.RequestDateValue, :t},
      description: :string,
      display_value: :string,
      enabled: :boolean,
      enum_options: [{Asana.EnumOption, :t}],
      enum_value: {Asana.CustomField.RequestEnumValue, :t},
