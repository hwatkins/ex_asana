defmodule Asana.CustomType.Membership do
  @moduledoc """
  Provides struct and types for a CustomType.Membership
  """
  use Asana.Encoder
  ...
  @type compact :: %__MODULE__{
          ...
          parent: Asana.CustomType.compact() | nil,
  ...
  def __fields__(:compact) do
    [
      ...
      parent: {Asana.CustomType, :compact},
