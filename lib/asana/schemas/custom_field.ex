defmodule Asana.CustomField do
  @moduledoc """
  Provides struct and types for a CustomField
  """
  use Asana.Encoder

  @type compact :: %__MODULE__{
          __info__: map,
          date_value: Asana.CustomField.DateValue.compact() | nil,
          display_value: String.t() | nil,
          enabled: boolean | nil,
          enum_options: [Asana.EnumOption.t()] | nil,
          enum_value: Asana.CustomField.EnumValue.compact() | nil,
          gid: String.t() | nil,
          id_prefix: String.t() | nil,
          input_restrictions: [String.t()] | nil,
          is_formula_field: boolean | nil,
          multi_enum_values: [Asana.EnumOption.t()] | nil,
          name: String.t() | nil,
  ...
  @type response :: %__MODULE__{
          ...
          name: String.t() | nil,
          number_value: number | nil,
          people_value: [Asana.User.compact()] | nil,
          precision: integer | nil,
          privacy_setting: String.t() | nil,
          reference_value: [Asana.AsanaNamedResource.t()] | nil,
          representation_type: String.t() | nil,
  ...
  def __fields__(:compact) do
    [
      date_value: {Asana.CustomField.DateValue, :compact},
      display_value: :string,
      enabled: :boolean,
      enum_options: [{Asana.EnumOption, :t}],
      enum_value: {Asana.CustomField.EnumValue, :compact},
      gid: :string,
      id_prefix: :string,
      input_restrictions: [:string],
      is_formula_field: :boolean,
      multi_enum_values: [{Asana.EnumOption, :t}],
      name: :string,
      number_value: :number,
      representation_type:
        {:enum,
  ...
  def __fields__(:response) do
    [
      ...
      name: :string,
      number_value: :number,
      people_value: [{Asana.User, :compact}],
      precision: :integer,
      privacy_setting: {:enum, ["public_with_guests", "public", "private"]},
      reference_value: [{Asana.AsanaNamedResource, :t}],
      representation_type:
        {:enum,
         [
           "text",
