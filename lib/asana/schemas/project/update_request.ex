defmodule Asana.Project.UpdateRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          current_status: Asana.Project.UpdateRequestCurrentStatus.t() | nil,
          current_status_update: Asana.Project.UpdateRequestCurrentStatusUpdate.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      current_status: {Asana.Project.UpdateRequestCurrentStatus, :t},
      current_status_update: {Asana.Project.UpdateRequestCurrentStatusUpdate, :t},
